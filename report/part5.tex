...
\lstinputlisting[language=Matlab, basicstyle=\small, caption={Matlab implementation of the discrete Kalman filter}, label={lst:listing2},float]{listings/kalman.m}
