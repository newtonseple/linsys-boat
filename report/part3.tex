...
Inserting \cref{eq:T_f} into \cref{eq:K_pd(T_f)} yields a $K_{pd} = 0.7494$. The controller was implemented as seen in \cref{fig:pd}.

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{images/oppg3/a-pd-loop.pdf}
    \caption{Implementation of the PD-controller}
    \label{fig:pd}
\end{figure}
